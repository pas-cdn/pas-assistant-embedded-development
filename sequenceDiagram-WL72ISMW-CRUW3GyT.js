import { a as me, b as Kt, g as ct, d as we, c as Xt, e as Jt } from "./chunk-TZMSLE5B-DOz2bxOp.js";
import { _ as f, E as ve, k as st, l as Nt, m as Q, w as ae, n as Ie, o as Le, y as I, j as ee, s as _e, I as Ae, i as ke, h as Pe, J as Ne, K as Se, L as Me, P as Re, q as St, H as W, a5 as z, a6 as Lt, a7 as re, a8 as De, a9 as Ce, aa as ie, Z as zt } from "./mermaid-VLURNSYL-KtsFwY3v.js";
import { I as Oe } from "./chunk-QZHKN3VN-CH5_uzv8.js";
var Ht = function() {
  var e = /* @__PURE__ */ f(function(pt, v, A, L) {
    for (A = A || {}, L = pt.length; L--; A[pt[L]] = v) ;
    return A;
  }, "o"), t = [1, 2], n = [1, 3], s = [1, 4], r = [2, 4], i = [1, 9], c = [1, 11], h = [1, 13], o = [1, 14], a = [1, 16], p = [1, 17], g = [1, 18], x = [1, 24], y = [1, 25], m = [1, 26], w = [1, 27], k = [1, 28], N = [1, 29], S = [1, 30], O = [1, 31], B = [1, 32], q = [1, 33], H = [1, 34], Z = [1, 35], at = [1, 36], U = [1, 37], G = [1, 38], F = [1, 39], D = [1, 41], $ = [1, 42], K = [1, 43], j = [1, 44], rt = [1, 45], R = [1, 46], E = [1, 4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 47, 48, 49, 50, 52, 53, 55, 60, 61, 62, 63, 71], _ = [2, 71], X = [4, 5, 16, 50, 52, 53], tt = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 50, 52, 53, 55, 60, 61, 62, 63, 71], M = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 49, 50, 52, 53, 55, 60, 61, 62, 63, 71], Bt = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 48, 50, 52, 53, 55, 60, 61, 62, 63, 71], Qt = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 47, 50, 52, 53, 55, 60, 61, 62, 63, 71], ot = [69, 70, 71], lt = [1, 127], Vt = {
    ...
    performAction: /* @__PURE__ */ f(function(v, A, L, b, C, d, vt) {
      var u = d.length - 1;
      switch (C) {
        case 3:
    ...
    parse: /* @__PURE__ */ f(function(v) {
      ...
      for (var Yt in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, Yt) && (ft.yy[Yt] = this.yy[Yt]);
      ...
      for (var J, yt, it, Ft, bt = {}, kt, ht, te, Pt; ; ) {
        if (yt = L[L.length - 1], this.defaultActions[yt] ? it = this.defaultActions[yt] : ((J === null || typeof J > "u") && (J = jt()), it = vt[yt] && vt[yt][J]), typeof it > "u" || !it.length || !it[0]) {
          ...
          Pt = [];
          for (kt in vt[yt])
            this.terminals_[kt] && kt > ye && Pt.push("'" + this.terminals_[kt] + "'");
          Y.showPosition ? qt = "Parse error on line " + (At + 1) + `:
` + Y.showPosition() + `
Expecting ` + Pt.join(", ") + ", got '" + (this.terminals_[J] || J) + "'" : qt = "Parse error on line " + (At + 1) + ": Unexpected " + (J == $t ? "end of input" : "'" + (this.terminals_[J] || J) + "'"), this.parseError(qt, {
            text: Y.match,
        ...
        switch (it[0]) {
          ...
          case 2:
            ...
            ]), Ft = this.performAction.apply(bt, [
              u,
              Zt,
              At,
              ft.yy,
...
` + r + `
    ...
    if (h) {
      ...
      if (i = h.box ? h.box : this.state.records.currentBox, h.box = i, h && t === h.name && n == null)
        return;
    }
    if (n?.text == null && (n = { text: t, type: s }), (s == null || n.text == null) && (n = { text: t, type: s }), this.state.records.actors.set(e, {
      box: i,
      name: t,
      description: n.text,
  ...
  activationCount(e) {
    ...
    for (t = 0; t < this.state.records.messages.length; t++)
      this.state.records.messages[t].type === this.LINETYPE.ACTIVE_START && this.state.records.messages[t].from === e && n++, this.state.records.messages[t].type === this.LINETYPE.ACTIVE_END && this.state.records.messages[t].from === e && n--;
    return n;
  }
  addMessage(e, t, n, s) {
  ...
  parseMessage(e) {
    const t = e.trim(), { wrap: n, cleanedText: s } = this.extractWrap(t), r = {
      text: s,
      wrap: n
    };
  ...
  parseBoxData(e) {
    ...
    let n = t?.[1] ? t[1].trim() : "transparent", s = t?.[2] ? t[2].trim() : void 0;
    if (window?.CSS)
      window.CSS.supports("color", n) || (n = "transparent", s = e.trim());
    else {
...
`, "getStyles"), ze = qe, Tt = 18 * 2, gt = "actor-top", xt = "actor-bottom", Dt = "actor-box", ut = "actor-man", It = /* @__PURE__ */ f(function(e, t) {
  return we(e, t);
}, "drawRect"), He = /* @__PURE__ */ f(function(e, t, n, s, r) {
  ...
  if (x.attr("class", "actorPopupMenuPanel" + p), x.attr("x", h.x), x.attr("y", h.height), x.attr("fill", h.fill), x.attr("stroke", h.stroke), x.attr("width", g), x.attr("height", h.height), x.attr("rx", h.rx), x.attr("ry", h.ry), i != null) {
    var y = 20;
    for (let k in i) {
      var m = a.append("a"), w = ae(i[k]);
      m.attr("xlink:href", w), m.attr("target", "_blank"), ps(s)(
        k,
        m,
        h.x + 10,
        h.height + y,
  ...
  return [s];
}, "drawKatex"), wt = /* @__PURE__ */ f(function(e, t) {
  let n = 0, s = 0;
  ...
  return h;
}, "drawText"), ne = /* @__PURE__ */ f(function(e, t) {
...
}, "drawLabel"), P = -1, oe = /* @__PURE__ */ f((e, t, n, s) => {
...
}, "fixLifeLineHeights"), Ue = /* @__PURE__ */ f(function(e, t, n, s) {
  ...
  return x;
}, "drawActorTypeParticipant"), Ge = /* @__PURE__ */ f(function(e, t, n, s) {
  const r = s ? t.stopy : t.starty, i = t.x + t.width / 2, c = r + t.height, h = e.append("g").lower();
  var o = h;
  s || (P++, Object.keys(t.links || {}).length && !n.forceMenus && o.attr("onclick", Ct(`actor${P}_popup`)).attr("cursor", "pointer"), o.append("line").attr("id", "actor" + P).attr("x1", i).attr("y1", c).attr("x2", i).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name), o = h.append("g"), t.actorCnt = P, t.links != null && o.attr("id", "root-" + P));
  const a = ct();
  ...
  if (It(o, x), t.rectData = a, t.properties?.icon) {
  ...
  return m;
}, "drawActorTypeCollections"), Ke = /* @__PURE__ */ f(function(e, t, n, s) {
  const r = s ? t.stopy : t.starty, i = t.x + t.width / 2, c = r + t.height, h = e.append("g").lower();
  let o = h;
  s || (P++, Object.keys(t.links || {}).length && !n.forceMenus && o.attr("onclick", Ct(`actor${P}_popup`)).attr("cursor", "pointer"), o.append("line").attr("id", "actor" + P).attr("x1", i).attr("y1", c).attr("x2", i).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name), o = h.append("g"), t.actorCnt = P, t.links != null && o.attr("id", "root-" + P));
  const a = ct();
  ...
  return w;
}, "drawActorTypeQueue"), Xe = /* @__PURE__ */ f(function(e, t, n, s) {
...
}, "drawActorTypeEntity"), Qe = /* @__PURE__ */ f(function(e, t, n, s) {
...
`;
  ...
  return t.height;
}, "drawActorTypeDatabase"), Ze = /* @__PURE__ */ f(function(e, t, n, s) {
...
}, "drawActorTypeBoundary"), $e = /* @__PURE__ */ f(function(e, t, n, s) {
...
}, "drawActorTypeActor"), je = /* @__PURE__ */ f(async function(e, t, n, s) {
  switch (t.type) {
    case "actor":
...
}, "drawActor"), ts = /* @__PURE__ */ f(function(e, t, n) {
  const r = e.append("g");
  ce(r, t), t.name && dt(n)(
    t.name,
    r,
...
}, "drawBox"), es = /* @__PURE__ */ f(function(e) {
  return e.append("g");
}, "anchorElement"), ss = /* @__PURE__ */ f(function(e, t, n, s, r) {
...
}, "drawActivation"), as = /* @__PURE__ */ f(async function(e, t, n, s) {
  const {
    boxMargin: r,
    boxTextMargin: i,
    labelBoxHeight: c,
  ...
  if (t.sectionTitles !== void 0) {
    for (const [w, k] of Object.entries(t.sectionTitles))
      if (k.message) {
        y.text = k.message, y.x = t.startx + (t.stopx - t.startx) / 2, y.y = t.sections[w].y + r + i, y.class = "loopText", y.anchor = "middle", y.valign = "middle", y.tspan = !1, y.fontFamily = o, y.fontSize = a, y.fontWeight = p, y.wrap = t.wrap, z(y.text) ? (t.starty = t.sections[w].y, await Rt(g, y, t)) : wt(g, y);
        let N = Math.round(
...
}, "drawLoop"), ce = /* @__PURE__ */ f(function(e, t) {
  me(e, t);
}, "drawBackgroundRect"), rs = /* @__PURE__ */ f(function(e) {
...
}, "insertDatabaseIcon"), is = /* @__PURE__ */ f(function(e) {
...
}, "insertComputerIcon"), ns = /* @__PURE__ */ f(function(e) {
...
}, "insertClockIcon"), os = /* @__PURE__ */ f(function(e) {
...
}, "insertArrowHead"), cs = /* @__PURE__ */ f(function(e) {
...
}, "insertArrowFilledHead"), ls = /* @__PURE__ */ f(function(e) {
...
}, "insertSequenceNumber"), hs = /* @__PURE__ */ f(function(e) {
...
}, "insertArrowCrossHead"), le = /* @__PURE__ */ f(function() {
  return {
    x: 0,
    y: 0,
    fill: void 0,
...
}, "getTextObj"), ds = /* @__PURE__ */ f(function() {
  return {
    x: 0,
    y: 0,
    fill: "#EDF2AE",
  ...
  insertArrowHead: os,
  insertArrowFilledHead: cs,
  insertSequenceNumber: ls,
  insertArrowCrossHead: hs,
  insertDatabaseIcon: rs,
  insertComputerIcon: is,
  insertClockIcon: ns,
  getTextObj: le,
  getNoteRect: ds,
...
}, us = /* @__PURE__ */ f(async function(e, t) {
  ...
  const c = z(i.text) ? await Rt(s, i) : wt(s, i), h = Math.round(
...
f(he, "boundMessage");
var gs = /* @__PURE__ */ f(async function(e, t, n, s) {
  ...
  x.x = r, x.y = c + 10, x.width = i - r, x.class = "messageText", x.dy = "1em", x.text = h, x.fontFamily = l.messageFontFamily, x.fontSize = l.messageFontSize, x.fontWeight = l.messageFontWeight, x.anchor = l.messageAlign, x.valign = "center", x.textMargin = l.wrapPadding, x.tspan = !1, z(x.text) ? await Rt(e, x, { startx: r, stopx: i, starty: n }) : wt(e, x);
  const y = g.width;
  let m;
...
}, "addActorRenderingData"), Gt = /* @__PURE__ */ f(async function(e, t, n, s) {
  if (s) {
    let r = 0;
...
}, "drawActors"), de = /* @__PURE__ */ f(function(e, t, n, s) {
  let r = 0, i = 0;
  for (const c of n) {
    const h = t.get(c), o = ys(h), a = V.drawPopup(
      e,
      h,
      o,
      l,
...
}, "drawActorsPopup"), pe = /* @__PURE__ */ f(function(e) {
...
}, "setConf"), Ot = /* @__PURE__ */ f(function(e) {
  return T.activations.filter(function(t) {
    return t.actor === e;
  });
}, "actorActivations"), se = /* @__PURE__ */ f(function(e, t) {
  const n = t.get(e), s = Ot(e), r = s.reduce(
    function(c, h) {
...
var fs = /* @__PURE__ */ f(async function(e, t, n, s) {
  ...
  if (l.height = await xe(p, O, y), V.insertComputerIcon(a), V.insertDatabaseIcon(a), V.insertClockIcon(a), N && (T.bumpVerticalPos(l.boxMargin), S && T.bumpVerticalPos(y[0].textMaxHeight)), l.hideUnusedParticipants === !0) {
  ...
  Q.debug("createdActors", g), Q.debug("destroyedActors", x), await Gt(a, p, m, !1);
  for (const E of at)
    await gs(a, E.messageModel, E.lineStartY, s);
  l.mirrorActors && await Gt(a, p, m, !0), U.forEach((E) => V.drawBackgroundRect(a, E)), oe(a, p, m, l);
...
var Ts = /* @__PURE__ */ f(async function(e, t, n) {
  const s = t.get(e.from), r = t.get(e.to), i = s.x, c = r.x, h = e.wrap && e.message;
  let o = z(e.message) ? await Lt(e.message, st()) : W.calculateTextDimensions(
...
}, "buildNoteModel"), Es = /* @__PURE__ */ f(function(e, t, n) {
  if (![
...
}, "buildMessageModel"), bs = /* @__PURE__ */ f(async function(e, t, n, s) {
  const r = {}, i = [];
  let c, h, o;
  for (const a of e) {
    switch (a.type) {
      ...
      case s.db.LINETYPE.ACTIVE_START:
        {
          const g = t.get(a.from ? a.from : a.to.actor), x = Ot(a.from ? a.from : a.to.actor).length, y = g.x + g.width / 2 + (x - 1) * l.activationWidth / 2, m = {
            startx: y,
