import { _ as o, m as te, k as H, a1 as fe, ak as ye, al as be, am as me, ad as _e, $ as X, q as F, K as ke, L as Ee, ae as Se, af as ce, ag as le } from "./mermaid-VLURNSYL-KtsFwY3v.js";
import { g as Ne } from "./chunk-FMBD7UC4-CtoQw9Gv.js";
var $ = function() {
  var e = /* @__PURE__ */ o(function(O, i, n, r) {
    for (n = n || {}, r = O.length; r--; n[O[r]] = i) ;
    return n;
  }, "o"), u = [1, 4], p = [1, 13], s = [1, 12], d = [1, 15], k = [1, 16], b = [1, 20], l = [1, 19], D = [6, 7, 8], I = [1, 26], g = [1, 24], w = [1, 25], _ = [6, 7, 11], G = [1, 31], N = [6, 7, 11, 24], V = [1, 6, 13, 16, 17, 20, 23], m = [1, 35], A = [1, 36], L = [1, 6, 7, 11, 13, 16, 17, 20, 23], M = [1, 38], T = {
    ...
    table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: u }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: u }, { 6: p, 7: [1, 10], 9: 9, 12: 11, 13: s, 14: 14, 16: d, 17: k, 18: 17, 19: 18, 20: b, 23: l }, e(D, [2, 3]), { 1: [2, 2] }, e(D, [2, 4]), e(D, [2, 5]), { 1: [2, 6], 6: p, 12: 21, 13: s, 14: 14, 16: d, 17: k, 18: 17, 19: 18, 20: b, 23: l }, { 6: p, 9: 22, 12: 11, 13: s, 14: 14, 16: d, 17: k, 18: 17, 19: 18, 20: b, 23: l }, { 6: I, 7: g, 10: 23, 11: w }, e(_, [2, 24], { 18: 17, 19: 18, 14: 27, 16: [1, 28], 17: [1, 29], 20: b, 23: l }), e(_, [2, 19]), e(_, [2, 21], { 15: 30, 24: G }), e(_, [2, 22]), e(_, [2, 23]), e(N, [2, 25]), e(N, [2, 26]), e(N, [2, 28], { 20: [1, 32] }), { 21: [1, 33] }, { 6: I, 7: g, 10: 34, 11: w }, { 1: [2, 7], 6: p, 12: 21, 13: s, 14: 14, 16: d, 17: k, 18: 17, 19: 18, 20: b, 23: l }, e(V, [2, 14], { 7: m, 11: A }), e(L, [2, 8]), e(L, [2, 9]), e(L, [2, 10]), e(_, [2, 16], { 15: 37, 24: G }), e(_, [2, 17]), e(_, [2, 18]), e(_, [2, 20], { 24: M }), e(N, [2, 31]), { 21: [1, 39] }, { 22: [1, 40] }, e(V, [2, 13], { 7: m, 11: A }), e(L, [2, 11]), e(L, [2, 12]), e(_, [2, 15], { 24: M }), e(N, [2, 30]), { 22: [1, 41] }, e(N, [2, 27]), e(N, [2, 29])],
    ...
    parse: /* @__PURE__ */ o(function(i) {
      ...
      for (var E, P, x, Q, j = {}, z, C, oe, K; ; ) {
        if (P = r[r.length - 1], this.defaultActions[P] ? x = this.defaultActions[P] : ((E === null || typeof E > "u") && (E = ae()), x = U[P] && U[P][E]), typeof x > "u" || !x.length || !x[0]) {
          ...
          K = [];
          for (z in U[P])
            this.terminals_[z] && z > ue && K.push("'" + this.terminals_[z] + "'");
          y.showPosition ? Z = "Parse error on line " + (W + 1) + `:
` + y.showPosition() + `
Expecting ` + K.join(", ") + ", got '" + (this.terminals_[E] || E) + "'" : Z = "Parse error on line " + (W + 1) + ": Unexpected " + (E == re ? "end of input" : "'" + (this.terminals_[E] || E) + "'"), this.parseError(Z, {
            text: y.match,
        ...
        switch (x[0]) {
          case 1:
            r.push(E), h.push(y.yytext), t.push(y.yylloc), r.push(x[1]), E = null, se = y.yyleng, c = y.yytext, W = y.yylineno, J = y.yylloc;
            break;
          case 2:
            if (C = this.productions_[x[1]][1], j.$ = h[h.length - C], j._$ = {
              ...
              return Q;
            C && (r = r.slice(0, -1 * C * 2), h = h.slice(0, -1 * C), t = t.slice(0, -1 * C)), r.push(this.productions_[x[1]][0]), h.push(j.$), t.push(j._$), oe = U[r[r.length - 2]][r[r.length - 1]], r.push(oe);
            break;
          case 3:
            return !0;
        }
...
var xe = $, v = [], ne = [], ee = 0, ie = {}, ve = /* @__PURE__ */ o(() => {
  ...
  const k = H();
  let b = k.mindmap?.padding ?? X.mindmap.padding;
  switch (s) {
    case f.ROUNDED_RECT:
    case f.RECT:
    case f.HEXAGON:
  ...
  const l = {
    ...
    level: e,
    label: F(p, k),
    width: k.mindmap?.maxNodeWidth ?? X.mindmap.maxNodeWidth,
    padding: b,
    isGroup: !1
  };
  if (d !== void 0) {
...
` + e);
  ...
  for (const m of g) {
    ...
    let T = M;
    const Y = k.nodes.filter((i) => i.parentId === m.id);
    for (const i of Y) {
      if (i.isGroup)
  ...
  _e(
    void 0,
    l,
    b.mindmap?.padding ?? X.kanban.padding,
    b.mindmap?.useMaxWidth ?? X.kanban.useMaxWidth
  );
}, "draw"), je = {
  draw: Be
}, Fe = /* @__PURE__ */ o((e) => {
