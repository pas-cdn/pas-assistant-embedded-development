import { g as Zt } from "./chunk-55IACEB6-Dd_pyfVQ.js";
import { s as te } from "./chunk-QN33PNHL-vIkaHt4w.js";
import { _ as d, m as _, k as w, G as ee, H as se, i as ie, j as re, h as ae, s as ne, I as oe, J as le, ac as ce, y as U, P as he } from "./mermaid-VLURNSYL-KtsFwY3v.js";
var kt = function() {
  var t = /* @__PURE__ */ d(function(G, a, c, r) {
    for (c = c || {}, r = G.length; r--; c[G[r]] = a) ;
    return c;
...
kt.parser = kt;
var Ye = kt, ue = "TB", Ft = "TB", It = "dir", K = "state", z = "root", vt = "relation", de = "classDef", fe = "style", pe = "applyClass", Z = "default", Gt = "divider", Yt = "fill:none", Bt = "fill: #333", Vt = "c", Mt = "text", Ut = "normal", bt = "rect", Dt = "rectWithTitle", Se = "stateStart", ye = "stateEnd", Ot = "divider", Rt = "roundedWithTitle", ge = "note", Te = "noteGroup", tt = "statediagram", Ee = "state", _e = `${tt}-${Ee}`, jt = "transition", me = "note", be = "note-edge", De = `${jt} ${be}`, ke = `${tt}-${me}`, ve = "cluster", Ce = `${tt}-${ve}`, Ae = "cluster-alt", xe = `${tt}-${Ae}`, Ht = "parent", Wt = "note", Le = "state", Ct = "----", Ie = `${Ct}${Wt}`, Nt = `${Ct}${Ht}`, zt = /* @__PURE__ */ d((t, e = Ft) => {
  if (!t.doc)
    return e;
  let o = e;
  ...
  g.type = s.type, g.layoutAlgorithm = S, g.nodeSpacing = u?.nodeSpacing || 50, g.rankSpacing = u?.rankSpacing || 50, g.markers = ["barb"], g.diagramId = e, await ee(g, n);
  const T = 8;
  try {
...
var Q = /* @__PURE__ */ d((t, e, o, s, h, u, S, g) => {
  ...
  if (_.info("dataFetcher parsedItem", e, T, C), n !== "root") {
    ...
    if (D.shape === Ot && (D.label = ""), t && t.id !== "root" && (_.trace("Setting node ", n, " to be child of its parent ", t.id), D.parentId = t.id), D.centerLabel = !0, e.note) {
      ...
      Y++, $.id = L, R.parentId = L, q(s, $, g), q(s, R, g), q(s, D, g);
      let I = n, P = R.id;
  ...
  docTranslator(t, e, o) {
    ...
    if (e.stmt === K && (e.id === v.START_NODE ? (e.id = t.id + (o ? "_start" : "_end"), e.start = o) : e.id = e.id.trim()), e.stmt !== z && e.stmt !== K || !e.doc)
      return;
    const s = [];
    let h = [];
