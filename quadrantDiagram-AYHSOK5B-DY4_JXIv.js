...
var Ct = function() {
  var t = /* @__PURE__ */ r(function(M, s, l, u) {
    ...
    parse: /* @__PURE__ */ r(function(s) {
      ...
      r(Jt, "lex");
      for (var w, j, N, Ft, st = {}, pt, X, Zt, yt; ; ) {
        if (j = u[u.length - 1], this.defaultActions[j] ? N = this.defaultActions[j] : ((w === null || typeof w > "u") && (w = Jt()), N = ht[j] && ht[j][w]), typeof N > "u" || !N.length || !N[0]) {
          var Pt = "";
          yt = [];
          for (pt in ht[j])
        ...
        switch (N[0]) {
          ...
          case 2:
            if (X = this.productions_[N[1]][1], st.$ = A[A.length - X], st._$ = {
              ...
              return Ft;
            X && (u = u.slice(0, -1 * X * 2), A = A.slice(0, -1 * X), e = e.slice(0, -1 * X)), u.push(this.productions_[N[1]][0]), A.push(st.$), e.push(st._$), Zt = ht[u[u.length - 2]][u[u.length - 1]], u.push(Zt);
            break;
          case 3:
            return !0;
        }
