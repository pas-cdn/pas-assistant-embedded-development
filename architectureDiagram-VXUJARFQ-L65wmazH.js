import { _ as dt, a1 as Be, ad as Ze, m as Ie, j as ke, i as qe, I as Je, J as Qe, h as Ke, s as je, P as _e, Y as tr, Z as er, $ as rr, k as pe, ap as ye, aI as de, q as ir, l as ar, O as nr, aJ as or, aK as sr } from "./mermaid-VLURNSYL-KtsFwY3v.js";
import { p as hr } from "./chunk-4BX2VUAB-HhHWw7aj.js";
import { p as lr } from "./treemap-KMMF4GRG-Cc2R6JQP.js";
import { c as Re } from "./cytoscape.esm-DmsgT4DZ.js";
import { A as Ee, v as fr } from "./embed-entry-DNbXY835.js";
var Se = { exports: {} }, ge = { exports: {} }, ue = { exports: {} }, Me;
function cr() {
      ...
      return (
        ...
        function(M) {
          ...
          return N.m = M, N.c = G, N.i = function(d) {
            ...
            N.o(d, h) || Object.defineProperty(d, h, {
              /******/
              configurable: !1,
              /******/
              enumerable: !0,
          ...
          function(M, G, N) {
            ...
            function e(l, i, u) {
              d.call(this, u), this.isOverlapingSourceAndTarget = !1, this.vGraphObject = u, this.bendpoints = [], this.source = l, this.target = i;
            }
          ...
          function(M, G, N) {
            ...
            function o(c, f, T) {
              d.call(this, T), this.estimatedSize = h.MIN_VALUE, this.margin = a.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = !1, this.parent = c, f != null && f instanceof e ? this.graphManager = f : f != null && f instanceof Layout && (this.graphManager = f.graphManager);
            }
            ...
            o.prototype.getNodes = function() {
              ...
              for (var f = h.MAX_VALUE, T = -h.MAX_VALUE, g = h.MAX_VALUE, v = -h.MAX_VALUE, L, F, A, b, k, U = this.nodes, K = U.length, D = 0; D < K; D++) {
                var it = U[D];
              ...
              f == h.MAX_VALUE && (this.left = this.parent.getLeft(), this.right = this.parent.getRight(), this.top = this.parent.getTop(), this.bottom = this.parent.getBottom()), U[0].getParent().paddingLeft != null ? k = U[0].getParent().paddingLeft : k = this.margin, this.left = n.x - k, this.right = n.x + n.width + k, this.top = n.y - k, this.bottom = n.y + n.height + k;
            }, o.calculateBounds = function(c) {
              for (var f = h.MAX_VALUE, T = -h.MAX_VALUE, g = h.MAX_VALUE, v = -h.MAX_VALUE, L, F, A, b, k = c.length, U = 0; U < k; U++) {
                var K = c[U];
              ...
              for (F.forEach(function(D) {
                ...
                for (var A = v.length, b = 0; b < A; b++) {
                  var k = v[b];
                  if (L = k.getOtherEndInGraph(g, this), L != null && !T.has(L)) {
          ...
          function(M, G, N) {
            ...
            a.prototype.addRoot = function() {
              ...
              if (l == null && i == null && u == null) {
                ...
                if (t == o)
                  return l.isInterGraph = !1, t.add(l, i, u);
                if (l.isInterGraph = !0, l.source = i, l.target = u, this.edges.indexOf(l) > -1)
              ...
              if (e instanceof d) {
                ...
                for (var i, u = l.length, t = 0; t < u; t++)
                  i = l[t], r.remove(i);
                var o = [];
          ...
          function(M, G, N) {
            ...
            h.calcSeparationAmount = function(a, e, r, l) {
              ...
              if (a.intersects(e))
                return r[0] = l, r[1] = i, r[2] = u, r[3] = t, !0;
              var o = a.getX(), s = a.getY(), c = a.getRight(), f = a.getX(), T = a.getBottom(), g = a.getRight(), v = a.getWidthHalf(), L = a.getHeightHalf(), F = e.getX(), A = e.getY(), b = e.getRight(), k = e.getX(), U = e.getBottom(), K = e.getRight(), D = e.getWidthHalf(), it = e.getHeightHalf(), n = !1, m = !1;
              if (l === u) {
                if (i > t)
                  return r[0] = l, r[1] = s, r[2] = u, r[3] = U, !1;
                if (i < t)
                  return r[0] = l, r[1] = T, r[2] = u, r[3] = A, !1;
              } else if (i === t) {
                if (l > u)
                  return r[0] = o, r[1] = i, r[2] = b, r[3] = t, !1;
                if (l < u)
                ...
                if (-p === y ? l > u ? (r[0] = f, r[1] = T, n = !0) : (r[0] = c, r[1] = s, n = !0) : p === y && (l > u ? (r[0] = o, r[1] = s, n = !0) : (r[0] = g, r[1] = T, n = !0)), -E === y ? u > l ? (r[2] = k, r[3] = U, m = !0) : (r[2] = b, r[3] = A, m = !0) : E === y && (u > l ? (r[2] = F, r[3] = A, m = !0) : (r[2] = K, r[3] = U, m = !0)), n && m)
                  return !1;
                if (l > u ? i > t ? (I = this.getCardinalDirection(p, y, 4), w = this.getCardinalDirection(E, y, 2)) : (I = this.getCardinalDirection(-p, y, 3), w = this.getCardinalDirection(-E, y, 1)) : i > t ? (I = this.getCardinalDirection(-p, y, 1), w = this.getCardinalDirection(-E, y, 3)) : (I = this.getCardinalDirection(p, y, 2), w = this.getCardinalDirection(E, y, 4)), !n)
                  switch (I) {
                    case 1:
              ...
              var i = a.x, u = a.y, t = e.x, o = e.y, s = r.x, c = r.y, f = l.x, T = l.y, g = void 0, v = void 0, L = void 0, F = void 0, A = void 0, b = void 0, k = void 0, U = void 0, K = void 0;
              return L = o - u, A = i - t, k = t * u - i * o, F = T - c, b = s - f, U = f * c - s * T, K = L * b - F * A, K === 0 ? null : (g = (A * U - b * k) / K, v = (F * k - L * U) / K, new d(g, v));
          ...
          function(M, G, N) {
            ...
            var a = function(u) {
              ...
              function i(u) {
                var t = this;
                h(this, i), this.length = 0, this.head = null, this.tail = null, u?.forEach(function(o) {
                  return t.push(o);
                });
              }
              return d(i, [{
            ...
            o.RANDOM_SEED = 1, o.prototype = Object.create(t.prototype), o.prototype.getGraphManager = function() {
              ...
              if (s == null)
                ...
                for (var c, f, T = s.getNodes(), g = 0; g < T.length; g++)
                  c = T[g], f = c.getChild(), f == null || f.getNodes().length == 0 ? c.scatter() : (this.positionNodesRandomly(f), c.updateBounds());
            }, o.prototype.getFlatForest = function() {
              for (var s = [], c = !0, f = this.graphManager.getRoot().getNodes(), T = !0, g = 0; g < f.length; g++)
              ...
              for (A = A.concat(f); A.length > 0 && c; ) {
                for (L.push(A[0]); L.length > 0 && c; ) {
                  ...
                  for (var k = b.getEdges(), g = 0; g < k.length; g++) {
                    var U = k[g].getOtherEnd(b);
                    if (F.get(b) != U)
                      if (!v.has(U))
                        L.push(U), F.set(U, b);
                      else {
              ...
              var c = [];
              c = c.concat(s);
              var f = [], T = /* @__PURE__ */ new Map(), g = !1, v = null;
          ...
          function(M, G, N) {
            ...
            i.prototype.initParameters = function() {
              ...
              var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0, o = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1, s, c, f, T, g = this.getAllNodes(), v;
              if (this.useFRGridVariant)
                for (this.totalIterations % a.GRID_CALCULATION_CHECK_PERIOD == 1 && t && this.updateGrid(), v = /* @__PURE__ */ new Set(), s = 0; s < g.length; s++)
              ...
              var s = t.getRect(), c = o.getRect(), f = new Array(2), T = new Array(4), g, v, L, F, A, b, k;
              if (s.intersects(c)) {
                r.calcSeparationAmount(s, c, f, a.DEFAULT_EDGE_LENGTH / 2), b = 2 * f[0], k = 2 * f[1];
                var U = t.noOfChildren * o.noOfChildren / (t.noOfChildren + o.noOfChildren);
                t.repulsionForceX -= U * b, t.repulsionForceY -= U * k, o.repulsionForceX += U * b, o.repulsionForceY += U * k;
              } else
                this.uniformLeafNodeSizes && t.getChild() == null && o.getChild() == null ? (g = c.getCenterX() - s.getCenterX(), v = c.getCenterY() - s.getCenterY()) : (r.getIntersection(s, c, T), g = T[2] - T[0], v = T[3] - T[1]), Math.abs(g) < a.MIN_REPULSION_DIST && (g = l.sign(g) * a.MIN_REPULSION_DIST), Math.abs(v) < a.MIN_REPULSION_DIST && (v = l.sign(v) * a.MIN_REPULSION_DIST), L = g * g + v * v, F = Math.sqrt(L), A = (t.nodeRepulsion / 2 + o.nodeRepulsion / 2) * t.noOfChildren * o.noOfChildren / L, b = A * g / F, k = A * v / F, t.repulsionForceX -= b, t.repulsionForceY -= k, o.repulsionForceX += b, o.repulsionForceY += k;
                  ...
                  for (var L = t.startY - 1; L < t.finishY + 2; L++)
                    if (!(v < 0 || L < 0 || v >= g.length || L >= g[0].length)) {
                      for (var F = 0; F < g[v][L].length; F++)
                        if (T = g[v][L][F], !(t.getOwner() != T.getOwner() || t == T) && !o.has(T) && !f.has(T)) {
            ...
            d.svd = function(h) {
              ...
              for (var e = function(Tt) {
                ...
                for (var Ct = []; Tt-- > 0; )
                  Ct.push(0);
                return Ct;
              }(this.m), l = !0, i = Math.min(this.m - 1, this.n), u = Math.max(0, Math.min(this.n - 2, this.m)), t = 0; t < Math.max(i, u); t++) {
                if (t < i) {
                  this.s[t] = 0;
                  for (var o = t; o < this.m; o++)
                    this.s[t] = d.hypot(this.s[t], h[o][t]);
                  if (this.s[t] !== 0) {
              ...
              for (var $ = n - 1, _ = Math.pow(2, -52), ht = Math.pow(2, -966); n > 0; ) {
                ...
                for (J = n - 2; J >= -1 && J !== -1; J--)
                  if (Math.abs(e[J]) <= ht + _ * (Math.abs(this.s[J]) + Math.abs(this.s[J + 1]))) {
                    e[J] = 0;
                    break;
                  }
                if (J === n - 2)
                ...
                switch (J++, It) {
                  case 1:
                    {
                      ...
                      for (var gt = n - 2; gt >= J; gt--) {
                        ...
                        this.s[gt] = mt, gt !== J && (rt = -Ot * e[gt - 1], e[gt - 1] = At * e[gt - 1]);
                  ...
                  case 3:
                    {
                      var Yt = Math.max(Math.max(Math.max(Math.max(Math.abs(this.s[n - 1]), Math.abs(this.s[n - 2])), Math.abs(e[n - 2])), Math.abs(this.s[J])), Math.abs(e[J])), Vt = this.s[n - 1] / Yt, S = this.s[n - 2] / Yt, P = e[n - 2] / Yt, B = this.s[J] / Yt, Q = e[J] / Yt, Z = ((S + Vt) * (S - Vt) + P * P) / 2, at = Vt * P * (Vt * P), ct = 0;
                      /* @__PURE__ */ (function(Tt, Ct) {
                        return Tt || Ct;
                      })(Z !== 0, at !== 0) && (ct = Math.sqrt(Z * Z + at), Z < 0 && (ct = -ct), ct = at / (Z + ct));
                      for (var nt = (B + Vt) * (B - Vt) + ct, tt = B * Q, j = J; j < n - 1; j++) {
                        var ut = d.hypot(nt, tt), Mt = nt / ut, pt = tt / ut;
                        j !== J && (e[j - 1] = ut), nt = Mt * this.s[j] + pt * e[j], e[j] = Mt * e[j] - pt * this.s[j], tt = pt * this.s[j + 1], this.s[j + 1] = Mt * this.s[j + 1];
                        for (var xt = 0; xt < this.n; xt++)
                          ut = Mt * this.V[xt][j] + pt * this.V[xt][j + 1], this.V[xt][j + 1] = -pt * this.V[xt][j] + Mt * this.V[xt][j + 1], this.V[xt][j] = ut;
                        if (ut = d.hypot(nt, tt), Mt = nt / ut, pt = tt / ut, this.s[j] = ut, nt = Mt * e[j] + pt * this.s[j + 1], this.s[j + 1] = -pt * e[j] + Mt * this.s[j + 1], tt = pt * e[j + 1], e[j + 1] = Mt * e[j + 1], j < this.m - 1)
          ...
          function(M, G, N) {
            ...
            var a = function() {
              ...
              return d(e, [{
                ...
                key: "getAllIndexes",
                value: function(l, i) {
                  for (var u = [], t = -1; (t = l.indexOf(i, t + 1)) !== -1; )
                    u.push(t);
                  return u;
                }
              }, {
                ...
                D.prototype.newGraphManager = function() {
                  ...
                  if (this.constraints.relativePlacementConstraint) {
                    ...
                    if (s.RELAX_MOVEMENT_ON_CONSTRAINTS)
                      ...
                      var Y = function(H, $) {
                        var _ = [], ht = [], J = new K(), It = /* @__PURE__ */ new Set(), Nt = 0;
                        return H.forEach(function(vt, rt) {
                          if (!It.has(rt)) {
                            _[Nt] = [], ht[Nt] = !1;
                            var gt = rt;
                            for (J.push(gt), It.add(gt), _[Nt].push(gt); J.length != 0; ) {
                              gt = J.shift(), $.has(gt) && (ht[Nt] = !0);
                              var mt = H.get(gt);
                              mt.forEach(function(At) {
                                It.has(At) || (J.push(At), It.add(At), _[Nt].push(At));
                              });
                            }
                            Nt++;
                          }
                  ...
                  var y = k.calculateBounds(n), I = new U();
              ...
              (a, e, r) => {
                ...
                s.handleConstraints = function(c) {
                  ...
                  for (var T = /* @__PURE__ */ new Map(), g = /* @__PURE__ */ new Map(), v = [], L = [], F = c.getAllNodes(), A = 0, b = 0; b < F.length; b++) {
                    var k = F[b];
                    k.getChild() == null && (g.set(k.id, A++), v.push(k.getCenterX()), L.push(k.getCenterY()), T.set(k.id, k));
                  }
                  ...
                  var U = function(P, B) {
                    ...
                    return P.forEach(function(Z) {
                      B += v[g.get(Z)], Q += L[g.get(Z)];
                    }), { x: B / P.size, y: Q / P.size };
                  }, D = function(P, B, Q, Z, at) {
                    function ct(lt, ot) {
                    ...
                    nt.forEach(function(lt, ot) {
                      lt == 0 ? (ut.push(ot), Q || (B == "horizontal" ? tt.set(ot, g.has(ot) ? v[g.get(ot)] : Z.get(ot)) : tt.set(ot, g.has(ot) ? L[g.get(ot)] : Z.get(ot)))) : tt.set(ot, Number.NEGATIVE_INFINITY), Q && j.set(ot, /* @__PURE__ */ new Set([ot]));
                      ...
                      if (lt.forEach(function(st) {
                        ...
                        ot.forEach(function(st) {
                          B == "horizontal" ? (tt.set(st, g.has(st) ? v[g.get(st)] : Z.get(st)), Lt += tt.get(st)) : (tt.set(st, g.has(st) ? L[g.get(st)] : Z.get(st)), Lt += tt.get(st));
                        ...
                        lt.forEach(function(st) {
                          B == "horizontal" ? ft += g.has(st) ? v[g.get(st)] : Z.get(st) : ft += g.has(st) ? L[g.get(st)] : Z.get(st);
                    ...
                    for (var Mt = function() {
                      ...
                      Lt.forEach(function(ft) {
                        if (tt.get(ft.id) < tt.get(ot) + ft.gap)
                          if (Q && Q.has(ft.id)) {
                            var st = void 0;
                            if (B == "horizontal" ? st = g.has(ft.id) ? v[g.get(ft.id)] : Z.get(ft.id) : st = g.has(ft.id) ? L[g.get(ft.id)] : Z.get(ft.id), tt.set(ft.id, st), st < tt.get(ot) + ft.gap) {
                      ...
                      j.forEach(function(lt, ot) {
                        ...
                        try {
                          for (var bt = lt[Symbol.iterator](), zt; !(Tt = (zt = bt.next()).done); Tt = !0) {
                            ...
                            B == "horizontal" ? Zt = g.has(St) ? v[g.get(St)] : Z.get(St) : Zt = g.has(St) ? L[g.get(St)] : Z.get(St);
                            var Kt = tt.get(St);
                        ...
                        var se = (Lt + st) / 2 - (ft + Xt) / 2, Jt = !0, jt = !1, _t = void 0;
                        try {
                          for (var Qt = lt[Symbol.iterator](), ne; !(Jt = (ne = Qt.next()).done); Jt = !0) {
                            var te = ne.value;
                            tt.set(te, tt.get(te) + se);
                          }
                        } catch (ee) {
                          jt = !0, _t = ee;
                        } finally {
                    ...
                    if (P.forEach(function(j) {
                      j.left ? v[g.get(j.left)] - v[g.get(j.right)] >= 0 ? B++ : Q++ : L[g.get(j.top)] - L[g.get(j.bottom)] >= 0 ? Z++ : at++;
                    }), B > Q && Z > at)
                    ...
                    var B = [], Q = new u(), Z = /* @__PURE__ */ new Set(), at = 0;
                    ...
                    return P.forEach(function(Q, Z) {
                      B.set(Z, []);
                    }), P.forEach(function(Q, Z) {
                    ...
                    if (f.fixedNodeConstraint && f.fixedNodeConstraint.length > 1)
                      ...
                      (function() {
                        ...
                        if (f.alignmentConstraint.vertical) {
                          for (var P = f.alignmentConstraint.vertical, B = function(tt) {
                        ...
                        if (f.alignmentConstraint.horizontal) {
                          for (var Z = f.alignmentConstraint.horizontal, at = function(tt) {
                            ...
                            ut.size > 0 ? Mt = v[g.get(ut.values().next().value)] : Mt = K(j).y, Z[tt].forEach(function(pt) {
                      ...
                      if (V < x.size / 2)
                        it(f.relativePlacementConstraint), I = !1, w = !1;
                      else {
                        ...
                        q[Y].forEach(function(S, P) {
                          y[P] = [v[g.get(S)], L[g.get(S)]], E[P] = [], $.has(S) ? E[P][0] = $.get(S) : E[P][0] = v[g.get(S)], _.has(S) ? E[P][1] = _.get(S) : E[P][1] = L[g.get(S)];
                        }), I = !0;
                      }
                    }
                    if (I) {
                      ...
                      var vt = t.multMat(J, t.transpose(It)), rt = o.svd(vt);
                  ...
                  if (i.ENFORCE_CONSTRAINTS) {
                    if (f.fixedNodeConstraint && f.fixedNodeConstraint.length > 0) {
                      var Et = { x: 0, y: 0 };
                      f.fixedNodeConstraint.forEach(function(S, P) {
                        var B = { x: v[g.get(S.nodeId)], y: L[g.get(S.nodeId)] }, Q = S.position, Z = U(Q, B);
                        Et.x += Z.x, Et.y += Z.y;
                    ...
                    if (f.alignmentConstraint) {
                      if (f.alignmentConstraint.vertical)
                        for (var Dt = f.alignmentConstraint.vertical, Rt = function(P) {
                          var B = /* @__PURE__ */ new Set();
                          Dt[P].forEach(function(at) {
                            B.add(at);
                          });
                          var Q = new Set([].concat(l(B)).filter(function(at) {
                            return R.has(at);
                          })), Z = void 0;
                          Q.size > 0 ? Z = v[g.get(Q.values().next().value)] : Z = K(B).x, B.forEach(function(at) {
                            R.has(at) || (v[g.get(at)] = Z);
                          });
                        }, Ht = 0; Ht < Dt.length; Ht++)
                          Rt(Ht);
                      if (f.alignmentConstraint.horizontal)
                        for (var Ut = f.alignmentConstraint.horizontal, Pt = function(P) {
                          var B = /* @__PURE__ */ new Set();
                          ...
                          Q.size > 0 ? Z = L[g.get(Q.values().next().value)] : Z = K(B).y, B.forEach(function(at) {
                            R.has(at) || (L[g.get(at)] = Z);
                          });
                        }, Ft = 0; Ft < Ut.length; Ft++)
                          Pt(Ft);
                    }
                    f.relativePlacementConstraint && function() {
                      var S = /* @__PURE__ */ new Map(), P = /* @__PURE__ */ new Map(), B = /* @__PURE__ */ new Map(), Q = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map(), at = /* @__PURE__ */ new Map(), ct = /* @__PURE__ */ new Set(), nt = /* @__PURE__ */ new Set();
                        ...
                        if (f.alignmentConstraint.vertical)
                          for (var tt = f.alignmentConstraint.vertical, j = function(yt) {
                            B.set("dummy" + yt, []), tt[yt].forEach(function(wt) {
                              S.set(wt, "dummy" + yt), B.get("dummy" + yt).push(wt), R.has(wt) && ct.add("dummy" + yt);
                        ...
                        if (f.alignmentConstraint.horizontal)
                          for (var Mt = f.alignmentConstraint.horizontal, pt = function(yt) {
                            Q.set("dummy" + yt, []), Mt[yt].forEach(function(wt) {
                              P.set(wt, "dummy" + yt), Q.get("dummy" + yt).push(wt), R.has(wt) && nt.add("dummy" + yt);
                      ...
                      var bt = m(lt), zt = m(ot), St = n(bt), Zt = n(zt), Kt = p(lt), se = p(ot), Jt = [], jt = [];
                      St.forEach(function(Gt, yt) {
                        ...
                        jt[yt] = [], Gt.forEach(function(wt) {
                          se.get(wt).length == 0 && jt[yt].push(wt);
                        });
                      });
                      var _t = D(lt, "horizontal", ct, Z, Jt), Qt = D(ot, "vertical", nt, at, jt), ne = function(yt) {
                        B.get(yt) ? B.get(yt).forEach(function(wt) {
                          v[g.get(wt)] = _t.get(yt);
                        }) : v[g.get(yt)] = _t.get(yt);
                      }, te = !0, ee = !1, Te = void 0;
                      try {
                        for (var he = _t.keys()[Symbol.iterator](), Ne; !(te = (Ne = he.next()).done); te = !0) {
                          var le = Ne.value;
                          ne(le);
                        }
                      } catch (Gt) {
                      ...
                      var $e = function(yt) {
                        Q.get(yt) ? Q.get(yt).forEach(function(wt) {
                          L[g.get(wt)] = Qt.get(yt);
                        }) : L[g.get(yt)] = Qt.get(yt);
                      }, fe = !0, Le = !1, Ce = void 0;
                      try {
                        for (var ce = Qt.keys()[Symbol.iterator](), Ae; !(fe = (Ae = ce.next()).done); fe = !0) {
                          var le = Ae.value;
                          $e(le);
                        }
                      } catch (Gt) {
        ...
        var G = {
          ...
          548: (
            ...
            (a, e, r) => {
              ...
              u.getTopMostNodes = function(t) {
                ...
                var f = new i(), T = /* @__PURE__ */ new Set(), g = [], v = void 0, L = void 0, F = void 0, A = !1, b = 1, k = [], U = [], K = function() {
                  var it = t.collection();
                  U.push(it);
                ...
                do
                  K();
                while (!A);
                return c && k.length > 0 && c.set("dummy" + (c.size + 1), k), U;
                ...
                if (!s.fixedNodeConstraint) {
                  ...
                  if (s.quality == "draft") {
                    var v = !0, L = !1, F = void 0;
                    try {
                      for (var A = o.nodeIndexes[Symbol.iterator](), b; !(v = (b = A.next()).done); v = !0) {
                        var k = b.value, U = l(k, 2), K = U[0], D = U[1], it = s.cy.getElementById(K);
                        if (it) {
                ...
                for (var f = Number.MAX_SAFE_INTEGER, T = Number.MIN_SAFE_INTEGER, g = Number.MAX_SAFE_INTEGER, v = Number.MIN_SAFE_INTEGER, L = void 0, F = void 0, A = void 0, b = void 0, k = t.descendants().not(":parent"), U = k.length, K = 0; K < U; K++) {
                  var D = k[K];
                ...
                var n = function(x) {
                  ...
                  for (var et = q.length, z = 0; z < et; z++) {
                    ...
                    if (O.outerWidth() != null && O.outerHeight() != null)
                      if (Y.randomize)
                        if (!O.isParent())
                          $ = x.add(new u(V.graphManager, new t(K[U.get(O.id())] - _.w / 2, D[U.get(O.id())] - _.h / 2), new o(parseFloat(_.w), parseFloat(_.h))));
                        else {
                          var ht = l.calcBoundingBox(O, K, D, U);
                          O.intersection(p).length == 0 ? $ = x.add(new u(V.graphManager, new t(ht.topLeftX, ht.topLeftY), new o(ht.width, ht.height))) : $ = x.add(new u(V.graphManager, new t(ht.topLeftX, ht.topLeftY), new o(parseFloat(_.w), parseFloat(_.h))));
                        }
                      else
                        $ = x.add(new u(V.graphManager, new t(O.position("x") - _.w / 2, O.position("y") - _.h / 2), new o(parseFloat(_.w), parseFloat(_.h))));
                    else
                  ...
                  for (var Y = 0, et = 0, z = 0; z < V.length; z++) {
                    var O = V[z], H = it[O.data("source")], $ = it[O.data("target")];
          ...
          212: (
            ...
            (a, e, r) => {
              ...
              var u = r(658), t = r(548), o = r(657), s = o.spectralLayout, c = r(816), f = c.coseLayout, T = Object.freeze({
                ...
                return l(v, [{
                  key: "run",
                  value: function() {
                    var F = this, A = this.options, b = A.cy, k = A.eles, U = [], K = [], D = void 0, it = [];
                    ...
                    var m = void 0, p = !1;
                    if (b.layoutUtilities && A.packComponents && (m = b.layoutUtilities("get"), m || (m = b.layoutUtilities()), p = !0), k.nodes().length > 0)
                      if (p) {
                          ...
                          if (A.tile) {
                            ...
                            if (D.forEach(function(vt, rt) {
                              ...
                              for (var z = Y.length - 1; z >= 0; z--)
                                D.splice(Y[z], 1), U.splice(Y[z], 1), it.splice(Y[z], 1);
                            }
                          }
                        ...
                        if (D.length > 1) {
                          ...
                          D.forEach(function(vt, rt) {
                            var gt = void 0;
                            if (A.quality == "draft" && (gt = U[rt].nodeIndexes), vt.nodes().not($).length > 0) {
                              var mt = {};
                              mt.edges = [], mt.nodes = [];
                              var At = void 0;
                              vt.nodes().not($).forEach(function(Ot) {
                                if (A.quality == "draft")
                                  if (!Ot.isParent())
                                    At = gt.get(Ot.id()), mt.nodes.push({ x: U[rt].xCoords[At] - Ot.boundingbox().w / 2, y: U[rt].yCoords[At] - Ot.boundingbox().h / 2, width: Ot.boundingbox().w, height: Ot.boundingbox().h });
                                  else {
                    ...
                    var J = function(rt, gt) {
                      if (A.quality == "default" || A.quality == "proof") {
                        ...
                        }), A.nodeDimensionsIncludeLabels && (At.labelWidth && (At.labelPosHorizontal == "left" ? mt.x += At.labelWidth / 2 : At.labelPosHorizontal == "right" && (mt.x -= At.labelWidth / 2)), At.labelHeight && (At.labelPosVertical == "top" ? mt.y += At.labelHeight / 2 : At.labelPosVertical == "bottom" && (mt.y -= At.labelHeight / 2))), mt == null && (mt = { x: rt.position("x"), y: rt.position("y") }), {
                          x: mt.x,
                          y: mt.y
                        };
                      } else {
                    ...
                    if (A.quality == "default" || A.quality == "proof" || A.randomize) {
                      var It = t.calcParentsWithoutChildren(b, k), Nt = k.filter(function(vt) {
                        return vt.css("display") == "none";
                      });
                      A.eles = k.not(Nt), k.nodes().not(":parent").not(Nt).layoutPositions(F, A, J), It.length > 0 && It.forEach(function(vt) {
                        vt.position(J(vt));
                      });
                    } else
            ...
            (a, e, r) => {
              var l = r(548), i = r(140).layoutBase.Matrix, u = r(140).layoutBase.SVD, t = function(s) {
                var c = s.cy, f = s.eles, T = f.nodes(), g = f.nodes(":parent"), v = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Map(), F = /* @__PURE__ */ new Map(), A = [], b = [], k = [], U = [], K = [], D = [], it = [], n = [], m = void 0, p = 1e8, E = 1e-9, y = s.piTol, I = s.samplingType, w = s.nodeSeparation, R = void 0, W = function() {
                  for (var P = 0, B = 0, Q = !1; B < R; ) {
                    P = Math.floor(Math.random() * m), Q = !1;
                    for (var Z = 0; Z < B; Z++)
                      if (U[Z] == P) {
                        Q = !0;
                        break;
                  ...
                  for (var P = u.svd(it), B = P.S, Q = P.U, Z = P.V, at = B[0] * B[0] * B[0], ct = [], nt = 0; nt < R; nt++) {
                    ct[nt] = [];
                    for (var tt = 0; tt < R; tt++)
                  ...
                  for (var P = void 0, B = void 0, Q = [], Z = [], at = [], ct = [], nt = 0; nt < m; nt++)
                    Q[nt] = Math.random(), Z[nt] = Math.random();
                  Q = i.normalize(Q), Z = i.normalize(Z);
                  for (var tt = E, j = E, ut = void 0; ; ) {
                    for (var Mt = 0; Mt < m; Mt++)
                      at[Mt] = Q[Mt];
                    if (Q = i.multGamma(i.multL(i.multGamma(at), D, n)), P = i.dotProduct(at, Q), Q = i.normalize(Q), tt = i.dotProduct(at, Q), ut = Math.abs(tt / j), ut <= 1 + y && ut >= 1)
                      break;
                    j = tt;
                  }
                  ...
                  for (j = E; ; ) {
                    for (var xt = 0; xt < m; xt++)
                      ct[xt] = Z[xt];
                    if (ct = i.minusOp(ct, i.multCons(at, i.dotProduct(at, ct))), Z = i.multGamma(i.multL(i.multGamma(ct), D, n)), B = i.dotProduct(ct, Z), Z = i.normalize(Z), tt = i.dotProduct(ct, Z), ut = Math.abs(tt / j), ut <= 1 + y && ut >= 1)
                      break;
                    j = tt;
                  }
                  for (var lt = 0; lt < m; lt++)
                    ct[lt] = Z[lt];
                  b = i.multCons(at, Math.sqrt(Math.abs(P))), k = i.multCons(ct, Math.sqrt(Math.abs(B)));
                };
                ...
                g.forEach(function(S) {
                  for (var P = S.children().intersection(f); P.nodes(":childless").length == 0; )
                    P = P.nodes()[0].children().intersection(f);
                  var B = 0, Q = P.nodes(":childless")[0].connectedEdges().length;
                  P.nodes(":childless").forEach(function(Z, at) {
                    Z.connectedEdges().length < Q && (Q = Z.connectedEdges().length, B = at);
                  }), F.set(S.id(), P.nodes(":childless")[B].id());
                }), T.forEach(function(S) {
                  var P = void 0;
                  S.isParent() ? P = L.get(F.get(S.id())) : P = L.get(S.id()), S.neighborhood().nodes().forEach(function(B) {
                    f.intersection(S.edgesWith(B)).length > 0 && (B.isParent() ? A[P].push(F.get(B.id())) : A[P].push(B.id()));
                  });
                });
                var Nt = function(P) {
                  var B = L.get(P), Q = void 0;
                  v.get(P).forEach(function(Z) {
                    c.getElementById(Z).isParent() ? Q = F.get(Z) : Q = Z, A[B].push(Q), A[L.get(Q)].push(P);
                  });
                }, vt = !0, rt = !1, gt = void 0;
                try {
                ...
                if (m > 2) {
                  ...
                  for (var Rt = 0; Rt < R; Rt++)
                    n[Rt] = [];
                  return s.quality == "draft" || s.step == "all" ? (q(I), V(), Y(), Et = { nodeIndexes: L, xCoords: b, yCoords: k }) : (L.forEach(function(S, P) {
                    b.push(c.getElementById(P).position("x")), k.push(c.getElementById(P).position("y"));
                  }), Et = { nodeIndexes: L, xCoords: b, yCoords: k }), Et;
                } else {
                  var Ht = L.keys(), Ut = c.getElementById(Ht.next().value), Pt = Ut.position(), Ft = Ut.outerWidth();
                  if (b.push(Pt.x), k.push(Pt.y), m == 2) {
                    var Yt = c.getElementById(Ht.next().value), Vt = Yt.outerWidth();
                    b.push(Pt.x + Ft / 2 + Vt / 2 + s.idealEdgeLength), k.push(Pt.y);
                  }
                  return Et = { nodeIndexes: L, xCoords: b, yCoords: k }, Et;
                }
              };
...
var Oe = {
  ...
  L: /* @__PURE__ */ dt((C, X) => C - X + 2, "L"),
  R: /* @__PURE__ */ dt((C, X) => C - 2, "R"),
  T: /* @__PURE__ */ dt((C, X) => C - X + 2, "T"),
  B: /* @__PURE__ */ dt((C, X) => C - 2, "B")
}, vr = /* @__PURE__ */ dt(function(C) {
  return Wt(C) ? C === "L" ? "R" : "L" : C === "T" ? "B" : "T";
}, "getOppositeArchitectureDirection"), xe = /* @__PURE__ */ dt(function(C) {
  const X = C;
  ...
  const X = C;
  return X === "T" || X === "B";
}, "isArchitectureDirectionY"), me = /* @__PURE__ */ dt(function(C, X) {
  const M = Wt(C) && qt(X), G = qt(C) && Wt(X);
  return M || G;
}, "isArchitectureDirectionXY"), pr = /* @__PURE__ */ dt(function(C) {
  const X = C[0], M = C[1], G = Wt(X) && qt(M), N = qt(X) && Wt(M);
  return G || N;
}, "isArchitecturePairXY"), yr = /* @__PURE__ */ dt(function(C) {
  return C !== "LL" && C !== "RR" && C !== "TT" && C !== "BB";
}, "isValidArchitectureDirectionPair"), ve = /* @__PURE__ */ dt(function(C, X) {
  const M = `${C}${X}`;
  return yr(M) ? M : void 0;
}, "getArchitectureDirectionPair"), Er = /* @__PURE__ */ dt(function([C, X], M) {
  const G = M[0], N = M[1];
  return Wt(G) ? qt(N) ? [C + (G === "L" ? -1 : 1), X + (N === "T" ? 1 : -1)] : [C + (G === "L" ? -1 : 1), X] : Wt(N) ? [C + (N === "L" ? 1 : -1), X + (G === "T" ? 1 : -1)] : [C, X + (G === "T" ? 1 : -1)];
}, "shiftPositionByArchitectureDirectionPair"), mr = /* @__PURE__ */ dt(function(C) {
  return C === "LT" || C === "TL" ? [1, 1] : C === "BL" || C === "LB" ? [1, -1] : C === "BR" || C === "RB" ? [-1, -1] : [-1, 1];
}, "getArchitectureDirectionXYFactors"), Tr = /* @__PURE__ */ dt(function(C, X) {
  return me(C, X) ? "bend" : Wt(C) ? "horizontal" : "vertical";
}, "getArchitectureDirectionAlignment"), Nr = /* @__PURE__ */ dt(function(C) {
  return C.type === "service";
}, "isArchitectureService"), Lr = /* @__PURE__ */ dt(function(C) {
  return C.type === "junction";
}, "isArchitectureJunction"), Fe = /* @__PURE__ */ dt((C) => C.data(), "edgeData"), ie = /* @__PURE__ */ dt((C) => C.data(), "nodeData"), Cr = rr.architecture, be = class {
  constructor() {
    this.nodes = {}, this.groups = {}, this.edges = [], this.registeredIds = {}, this.elements = {}, this.setAccTitle = ke, this.getAccTitle = qe, this.setDiagramTitle = Je, this.getDiagramTitle = Qe, this.getAccDescription = Ke, this.setAccDescription = je, this.clear();
  }
  static {
  ...
  getDataStructures() {
    if (this.dataStructures === void 0) {
      const C = {}, X = Object.entries(this.nodes).reduce((a, [e, r]) => (a[e] = r.edges.reduce((l, i) => {
        const u = this.getNode(i.lhsId)?.in, t = this.getNode(i.rhsId)?.in;
        if (u && t && u !== t) {
          const o = Tr(i.lhsDir, i.rhsDir);
          o !== "bend" && (C[u] ??= {}, C[u][t] = o, C[t] ??= {}, C[t][u] = o);
        }
        if (i.lhsId === e) {
          const o = ve(i.lhsDir, i.rhsDir);
          o && (l[o] = i.rhsId);
        } else {
          const o = ve(i.rhsDir, i.lhsDir);
          o && (l[o] = i.lhsId);
        }
        return l;
      }, {}), a), {}), M = Object.keys(X)[0], G = { [M]: 1 }, N = Object.keys(X).reduce(
        (a, e) => e === M ? a : { ...a, [e]: 1 },
        {}
      ), d = /* @__PURE__ */ dt((a) => {
        const e = { [a]: [0, 0] }, r = [a];
...
`, "getStyles"), wr = Mr, re = /* @__PURE__ */ dt((C) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${C}</g>`, "wrapIcon"), ae = {
...
}, Or = /* @__PURE__ */ dt(async function(C, X, M) {
  ...
  await Promise.all(
    X.edges().map(async (e) => {
      ...
      const b = G + 4;
      if (u && (Wt(l) ? T += l === "L" ? -b : b : g += l === "T" ? -b : b + 18), c && (Wt(o) ? F += o === "L" ? -b : b : A += o === "T" ? -b : b + 18), !u && M.getNode(r)?.type === "junction" && (Wt(l) ? T += l === "L" ? d : -d : g += l === "T" ? d : -d), !c && M.getNode(t)?.type === "junction" && (Wt(o) ? F += o === "L" ? d : -d : A += o === "T" ? d : -d), e[0]._private.rscratch) {
        const k = C.insert("g");
        if (k.insert("path").attr("d", `M ${T},${g} L ${v},${L} L${F},${A} `).attr("class", "edge").attr("id", nr(r, t, { prefix: "L" })), i) {
          const U = Wt(l) ? oe[l](T, h) : T - a, K = qt(l) ? oe[l](g, h) : g - a;
          k.insert("polygon").attr("points", De[l](h)).attr("transform", `translate(${U},${K})`).attr("class", "arrow");
        }
        if (s) {
          const U = Wt(o) ? oe[o](F, h) : F - a, K = qt(o) ? oe[o](A, h) : A - a;
          k.insert("polygon").attr("points", De[o](h)).attr("transform", `translate(${U},${K})`).attr("class", "arrow");
        }
        if (f) {
          ...
          if (await ye(
            ...
            pe()
          ), D.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), U === "X")
            D.attr("transform", "translate(" + v + ", " + L + ")");
          else if (U === "Y")
            D.attr("transform", "translate(" + v + ", " + L + ") rotate(-90)");
          else if (U === "XY") {
            const it = ve(l, o);
            if (it && pr(it)) {
              const n = D.node().getBoundingClientRect(), [m, p] = mr(it);
...
}, "drawEdges"), Dr = /* @__PURE__ */ dt(async function(C, X, M) {
  const N = M.getConfigField("padding") * 0.75, d = M.getConfigField("fontSize"), a = M.getConfigField("iconSize") / 2;
  await Promise.all(
    X.nodes().map(async (e) => {
      const r = ie(e);
      if (r.type === "group") {
        const { h: l, w: i, x1: u, y1: t } = e.boundingBox(), o = C.append("rect");
        o.attr("id", `group-${r.id}`).attr("x", u + a).attr("y", t + a).attr("width", i).attr("height", l).attr("class", "node-bkg");
        const s = C.append("g");
        let c = u, f = t;
        if (r.icon) {
          const T = s.append("g");
          T.html(
            `<g>${await de(r.icon, { height: N, width: N, fallbackPrefix: ae.prefix })}</g>`
          ), T.attr(
            "transform",
...
}, "drawGroups"), xr = /* @__PURE__ */ dt(async function(C, X, M) {
  const G = pe();
  for (const N of M) {
    ...
    if (N.icon)
      a.html(
        `<g>${await de(N.icon, { height: h, width: h, fallbackPrefix: ae.prefix })}</g>`
      );
    else if (N.iconText) {
      a.html(
        `<g>${await de("blank", { height: h, width: h, fallbackPrefix: ae.prefix })}</g>`
      );
      const u = a.append("g").append("foreignObject").attr("width", h).attr("height", h).append("div").attr("class", "node-icon-text").attr("style", `height: ${h}px;`).append("div").html(ir(N.iconText, G)), t = parseInt(
        window.getComputedStyle(u.node(), null).getPropertyValue("font-size").replace(/\D/g, "")
      ) ?? 16;
  ...
  return 0;
}, "drawServices"), Ir = /* @__PURE__ */ dt(function(C, X, M) {
  M.forEach((G) => {
...
function He(C, X) {
  C.forEach((M) => {
    const { lhsId: G, rhsId: N, lhsInto: d, lhsGroup: h, rhsInto: a, lhsDir: e, rhsDir: r, rhsGroup: l, title: i } = M, u = me(M.lhsDir, M.rhsDir) ? "segments" : "straight", t = {
      id: `${G}-${N}`,
      label: i,
      source: G,
      sourceDir: e,
...
function We(C, X, M) {
  const G = /* @__PURE__ */ dt((a, e) => Object.entries(a).reduce(
    ...
    return Object.entries(a).forEach(([l, [i, u]]) => {
      ...
      e[u] ??= {}, e[u][t] ??= [], e[u][t].push(l), r[i] ??= {}, r[i][t] ??= [], r[i][t].push(l);
    }), {
      horiz: Object.values(G(e, "horizontal")).filter(
        (l) => l.length > 1
      ),
      vert: Object.values(G(r, "vertical")).filter(
        (l) => l.length > 1
      )
    };
  }), [d, h] = N.reduce(
...
dt(We, "getAlignments");
function Ve(C, X) {
  const M = [], G = /* @__PURE__ */ dt((d) => `${d[0]},${d[1]}`, "posToStr"), N = /* @__PURE__ */ dt((d) => d.split(",").map((h) => parseInt(h)), "strToPos");
  return C.forEach((d) => {
    const h = Object.fromEntries(
      Object.entries(d).map(([l, i]) => [G(i), l])
    ), a = [G([0, 0])], e = {}, r = {
      L: [-1, 0],
      R: [1, 0],
      T: [0, 1],
...
function ze(C, X, M, G, N, { spatialMaps: d, groupAlignments: h }) {
  return new Promise((a) => {
    const e = ar("body").append("div").attr("id", "cy").attr("style", "display:none"), r = Re({
    ...
    const l = We(N, d, h), i = Ve(d, N), u = r.layout({
      name: "fcose",
      quality: "proof",
      styleEnabled: !1,
      animate: !1,
    ...
    u.one("layoutstop", () => {
      ...
      for (const o of Object.values(r.edges()))
        if (o.data?.()) {
          ...
          if (s !== f && c !== T) {
            const g = o.sourceEndpoint(), v = o.targetEndpoint(), { sourceDir: L } = Fe(o), [F, A] = qt(L) ? [g.x, v.y] : [v.x, g.y], { weights: b, distances: k } = t(g, v, F, A);
            o.style("segment-distances", k), o.style("segment-weights", b);
          }
        }
      r.endBatch(), u.run();
    }), u.run(), r.ready((t) => {
...
var Rr = /* @__PURE__ */ dt(async (C, X, M, G) => {
  const N = G.db, d = N.getServices(), h = N.getJunctions(), a = N.getGroups(), e = N.getEdges(), r = N.getDataStructures(), l = Be(X), i = l.append("g");
  i.attr("class", "architecture-edges");
  const u = l.append("g");
  u.attr("class", "architecture-services");
  const t = l.append("g");
  t.attr("class", "architecture-groups"), await xr(N, u, d), Ir(N, u, h);
  const o = await ze(d, h, a, e, N, r);
  await Or(i, o, N), await Dr(t, o, N), Ye(N, o), Ze(void 0, l, N.getConfigField("padding"), N.getConfigField("useMaxWidth"));
}, "draw"), Sr = { draw: Rr }, Yr = {
  parser: Pe,
  get db() {
    return new be();
