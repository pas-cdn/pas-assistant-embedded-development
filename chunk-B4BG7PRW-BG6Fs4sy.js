import { g as Ze } from "./chunk-FMBD7UC4-CtoQw9Gv.js";
import { g as $e } from "./chunk-55IACEB6-Dd_pyfVQ.js";
import { s as et } from "./chunk-QN33PNHL-vIkaHt4w.js";
import { _ as p, m as ve, k as D, F as tt, G as st, H as Ie, l as J, j as it, i as at, s as nt, h as rt, I as ut, J as lt, y as x, P as ot, O as ct, q as ht, ab as M } from "./mermaid-VLURNSYL-KtsFwY3v.js";
var Oe = function() {
  var e = /* @__PURE__ */ p(function(v, l, o, d) {
    for (o = o || {}, d = v.length; d--; o[v[d]] = l) ;
    return o;
  }, "o"), i = [1, 18], r = [1, 19], u = [1, 20], a = [1, 41], c = [1, 42], A = [1, 26], f = [1, 24], k = [1, 25], _ = [1, 32], he = [1, 33], de = [1, 34], m = [1, 45], pe = [1, 35], Ae = [1, 36], fe = [1, 37], ge = [1, 38], me = [1, 27], Ce = [1, 28], be = [1, 29], Ee = [1, 30], ye = [1, 31], C = [1, 44], b = [1, 46], E = [1, 43], y = [1, 47], Te = [1, 9], h = [1, 8, 9], Z = [1, 58], $ = [1, 59], ee = [1, 60], te = [1, 61], se = [1, 62], ke = [1, 63], De = [1, 64], R = [1, 8, 9, 41], we = [1, 76], V = [1, 8, 9, 12, 13, 22, 39, 41, 44, 68, 69, 70, 71, 72, 73, 74, 79, 81], ie = [1, 8, 9, 12, 13, 18, 20, 22, 39, 41, 44, 50, 60, 68, 69, 70, 71, 72, 73, 74, 79, 81, 86, 100, 102, 103], ae = [13, 60, 86, 100, 102, 103], G = [13, 60, 73, 74, 86, 100, 102, 103], Ve = [13, 60, 68, 69, 70, 71, 72, 86, 100, 102, 103], Fe = [1, 100], U = [1, 117], z = [1, 113], K = [1, 109], Y = [1, 115], j = [1, 110], Q = [1, 111], W = [1, 112], X = [1, 114], H = [1, 116], Pe = [22, 48, 60, 61, 82, 86, 87, 88, 89, 90], Be = [1, 8, 9, 39, 41, 44], ne = [1, 8, 9, 22], Me = [1, 145], Re = [1, 8, 9, 61], N = [1, 8, 9, 22, 48, 60, 61, 82, 86, 87, 88, 89, 90], _e = {
    ...
    performAction: /* @__PURE__ */ p(function(l, o, d, n, g, t, q) {
      var s = t.length - 1;
      switch (g) {
        case 8:
          this.$ = t[s - 1];
    ...
    parse: /* @__PURE__ */ p(function(l) {
      var o = this, d = [0], n = [], g = [null], t = [], q = this.table, s = "", ue = 0, Ge = 0, Xe = 2, Ue = 1, He = t.slice.call(arguments, 1), T = Object.create(this.lexer), I = { yy: {} };
...
var Et = Oe, Ye = ["#", "+", "~", "-", ""], je = class {
...
}, ce = "classId-", Qe = 0, w = /* @__PURE__ */ p((e) => x.sanitizeText(e, D()), "sanitizeText"), yt = class {
  constructor() {
    this.relations = [], this.classes = /* @__PURE__ */ new Map(), this.styleClasses = /* @__PURE__ */ new Map(), this.notes = [], this.interfaces = [], this.namespaces = /* @__PURE__ */ new Map(), this.namespaceCounter = 0, this.functions = [], this.lineType = {
      ...
      (i._groups || i)[0][0] === null && (i = J("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), J(e).select("svg").selectAll("g.node").on("mouseover", (a) => {
        ...
        i.transition().duration(500).style("opacity", 0), J(a.currentTarget).classed("hover", !1);
      });
  ...
  addMember(e, i) {
    ...
    if (typeof i == "string") {
      const a = i.trim();
      a.startsWith("<<") && a.endsWith(">>") ? u.annotations.push(w(a.substring(2, a.length - 2))) : a.indexOf(")") > 0 ? u.methods.push(new je(a, "method")) : a && u.members.push(new je(a, "attribute"));
    }
  }
  addMembers(e, i) {
...
`, "getStyles"), Tt = dt, pt = /* @__PURE__ */ p((e, i = "TB") => {
  ...
  f.type = u.type, f.layoutAlgorithm = tt(A), f.nodeSpacing = c?.nodeSpacing || 50, f.rankSpacing = c?.rankSpacing || 50, f.markers = ["aggregation", "extension", "composition", "dependency", "lollipop"], f.diagramId = i, await st(f, k);
  const _ = 8;
  Ie.insertTitle(
    k,
  ...
  ), et(k, _, "classDiagram", c?.useMaxWidth ?? !0);
}, "draw"), kt = {
  getClasses: At,
  draw: ft,
  getDir: pt
