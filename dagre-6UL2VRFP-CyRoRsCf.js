import { _ as w, aw as F, ax as Y, ay as _, az as H, m as i, k as V, aA as q, aB as z, al as U, aq as $, am as P, ak as K, aC as Q, aD as W, aE as Z } from "./mermaid-VLURNSYL-KtsFwY3v.js";
import { i as b, G as B } from "./graph-DeMOgDzm.js";
import { l as I } from "./layout-CSNGQbfr.js";
import { c as L } from "./clone-2-C7l0JU.js";
import { m as A } from "./min-xRCnjgeF.js";
function h(e) {
  var t = {
    options: {
...
Parent cluster`,
      ...
      if (i.info("(Insert) Node XXX" + f + ": " + JSON.stringify(t.node(f))), s?.clusterNode) {
        ...
        t.children(f).length > 0 ? (i.trace(
          ...
          "Graph:",
          t
        ), i.trace(C(s.id, t)), d.set(s.id, { id: C(s.id, t), node: s })) : (i.trace("Node - the non recursive path XAX", f, X, t.node(f), l), await U(X, t.node(f), { config: o, dir: l }));
    })
