import { g as oe } from "./chunk-FMBD7UC4-CtoQw9Gv.js";
import { _ as d, Z as rt, l as O, n as he, m as L, P as de, S as ge, k as R, an as ue, a9 as pe, ao as j, ap as Wt, aq as fe, H as $, y as xe, ar as ye, as as xt, q as yt, at as be } from "./mermaid-VLURNSYL-KtsFwY3v.js";
import { c as we } from "./clone-2-C7l0JU.js";
import { G as me } from "./graph-DeMOgDzm.js";
import { c as Le } from "./channel-8Vn778Mt.js";
import { q as Se, u as ke } from "./embed-entry-DNbXY835.js";
var bt = function() {
  var e = /* @__PURE__ */ d(function(D, y, g, f) {
    ...
    performAction: /* @__PURE__ */ d(function(y, g, f, m, E, h, W) {
      ...
      switch (E) {
        ...
        case 15:
          ...
          break;
        case 18:
          const I = parseInt(h[p]), G = m.generateId();
          this.$ = { id: G, type: "space", label: "", width: I, children: [] };
          break;
        case 23:
    ...
    parse: /* @__PURE__ */ d(function(y) {
      var g = this, f = [0], m = [], E = [null], h = [], W = this.table, p = "", I = 0, G = 0, V = 2, at = 1, ne = h.slice.call(arguments, 1), z = Object.create(this.lexer), q = { yy: {} };
...
Expecting ` + it.join(", ") + ", got '" + (this.terminals_[F] || F) + "'" : ft = "Parse error on line " + (I + 1) + ": Unexpected " + (F == at ? "end of input" : "'" + (this.terminals_[F] || F) + "'"), this.parseError(ft, {
        ...
        switch (H[0]) {
          case 1:
            f.push(F), E.push(z.yytext), h.push(z.yylloc), f.push(H[1]), F = null, G = z.yyleng, p = z.yytext, I = z.yylineno, ut = z.yylloc;
            break;
          case 2:
            if (Z = this.productions_[H[1]][1], Q.$ = E[E.length - Z], Q._$ = {
              ...
              return pt;
            Z && (f = f.slice(0, -1 * Z * 2), E = E.slice(0, -1 * Z), h = h.slice(0, -1 * Z)), f.push(this.productions_[H[1]][0]), E.push(Q.$), h.push(Q._$), Tt = W[f[f.length - 2]][f[f.length - 1]], f.push(Tt);
            break;
          case 3:
            return !0;
        }
...
}, "composition"), Ge = /* @__PURE__ */ d((e, t, a) => {
...
var Ar = /* @__PURE__ */ d(async (e, t) => {
  ...
  t.classData.members.forEach(async (E) => {
    ...
    let I = p.getBBox();
    if (j(R().flowchart.htmlLabels)) {
      const G = p.children[0], V = O(p);
      I = G.getBoundingClientRect(), V.attr("width", I.width), V.attr("height", I.height);
    }
