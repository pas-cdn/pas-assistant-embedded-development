import { _ as g, I as mt, J as kt, s as _t, h as xt, j as vt, i as bt, k as ot, Q as wt, l as G, ad as St, P as Lt, y as Et } from "./mermaid-VLURNSYL-KtsFwY3v.js";
import { C as At } from "./embed-entry-DNbXY835.js";
function Tt(t) {
...
function Wt(t) {
  var n = Vt, i = Ut, a = Bt, h = Rt, b = null;
  function p() {
...
st.parser = st;
var Q = st, q = [], K = [], X = /* @__PURE__ */ new Map(), qt = /* @__PURE__ */ g(() => {
...
${v}${Math.round(E * 100) / 100}${M}` : d, "getText");
  ...
  z.append("path").attr("d", Xt()).attr("stroke", D).attr("stroke-width", (d) => Math.max(1, d.width)), St(void 0, o, 0, x);
}, "draw"), ae = {
  draw: oe
}, le = /* @__PURE__ */ g((t) => t.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, `
`).trim(), "prepareTextForParsing"), ce = /* @__PURE__ */ g((t) => `.label {
      font-family: ${t.fontFamily};
    }`, "getStyles"), ue = ce, he = Q.parse.bind(Q);
Q.parse = (t) => he(le(t));
var de = {
  styles: ue,
  parser: Q,
