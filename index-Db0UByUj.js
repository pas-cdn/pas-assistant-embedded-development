import { ab as Ht, ac as mt, ad as Qt, ae as Bt, af as Xt, ag as Jt, ah as yt, ai as Zt, aj as At, J as Tt, r as L, ak as te, al as ee, am as re, c as zt, an as oe, a9 as U, F as Rt, ao as se, ap as gt, aq as jt, ar as Ot, as as ot, at as ae, au as ne, av as ie, aw as le, ax as ce, ay as de, az as ue, aA as vt, aB as pe, aC as It, aD as Nt, aE as fe } from "./embed-entry-DNbXY835.js";
import { G as ge, b as he } from "./list-threads.graphql-Dq-RIEMK.js";
...
const Ce = async (t, r, e) => {
  ...
  const t = Tt(), r = jt(), [e] = ce(), { initialMessagesFn: o } = de(), a = ue(
    ...
    () => new Set(a),
    [a]
  ), { data: i, isLoading: n } = Ae(), { data: c, isLoading: d } = Me(), { assistantProperties: u, isLoading: f } = st(), v = e.get("lastThreadId"), P = L.useMemo(() => {
    if (!r) return [];
...
}, Gt = 100, Ee = async (t, r, e = pe.page, o = Gt) => {
  const a = {
    token: t,
    assistantId: r,
    pagination: {
...
var Vt = (...t) => Ft(t).filter(Boolean), _t = (t, r) => {
  let e = {}, o = Object.keys(t), a = Object.keys(r);
  for (let s of o) if (a.includes(s)) {
    let i = t[s], n = r[s];
    Array.isArray(i) || Array.isArray(n) ? e[s] = Vt(n, i) : typeof i == "object" && typeof n == "object" ? e[s] = _t(i, n) : e[s] = n + " " + i;
  } else e[s] = t[s];
...
const ht = "-", ze = (t) => {
  ...
  return {
    getClassGroupId: (i) => {
      const n = i.split(ht);
      return n[0] === "" && n.length !== 1 && n.shift(), Yt(n, r) || Re(i);
    },
  ...
  const e = t[0], o = r.nextPart.get(e), a = o ? Yt(t.slice(1), o) : void 0;
  if (a)
    return a;
  ...
  const {
    ...
    const v = c.length === 0 ? n : n.substring(u), P = v.startsWith(qt), A = P ? v.substring(1) : v, k = f && f > u ? f - u : void 0;
    return {
      modifiers: c,
  ...
  for (let c = i.length - 1; c >= 0; c -= 1) {
    ...
    let A = !!P, k = o(A ? v.substring(0, P) : v);
    if (!k) {
      if (!A) {
        n = d + (n.length > 0 ? " " + n : n);
        continue;
    ...
    const m = Le(u).join(":"), C = f ? m + qt : m, y = C + k;
    if (s.includes(y))
      continue;
    s.push(y);
    const G = a(k, A);
...
function dt(t, ...r) {
  ...
  function i(c) {
    ...
    return e = Fe(d), o = e.cache.get, a = e.cache.set, s = n, n(c);
  }
  function n(c) {
    const d = o(c);
    if (d)
...
const E = (t) => {
...
}, Wt = /^\[(?:([a-z-]+):)?(.+)\]$/i, qe = /^\d+\/\d+$/, Ue = /* @__PURE__ */ new Set(["px", "full", "screen"]), We = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, De = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, Ke = /^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/, $e = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, He = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, F = (t) => W(t) || Ue.has(t) || qe.test(t), _ = (t) => D(t, "length", rr), W = (t) => !!t && !Number.isNaN(Number(t)), it = (t) => D(t, "number", W), B = (t) => !!t && Number.isInteger(Number(t)), Qe = (t) => t.endsWith("%") && W(t.slice(0, -1)), p = (t) => Wt.test(t), Y = (t) => We.test(t), Be = /* @__PURE__ */ new Set(["length", "size", "percentage"]), Xe = (t) => D(t, Be, Dt), Je = (t) => D(t, "position", Dt), Ze = /* @__PURE__ */ new Set(["image", "url"]), tr = (t) => D(t, Ze, sr), er = (t) => D(t, "", or), X = () => !0, D = (t, r, e) => {
  const o = Wt.exec(t);
  ...
  De.test(t) && !Ke.test(t)
), Dt = () => !1, or = (t) => $e.test(t), sr = (t) => He.test(t), ut = () => {
  const t = E("colors"), r = E("spacing"), e = E("blur"), o = E("brightness"), a = E("borderColor"), s = E("borderRadius"), i = E("borderSpacing"), n = E("borderWidth"), c = E("contrast"), d = E("grayscale"), u = E("hueRotate"), f = E("invert"), v = E("gap"), P = E("gradientColorStops"), A = E("gradientColorStopPositions"), k = E("inset"), m = E("margin"), C = E("opacity"), y = E("padding"), G = E("saturate"), R = E("scale"), O = E("sepia"), et = E("skew"), K = E("space"), $ = E("translate"), q = () => ["auto", "contain", "none"], H = () => ["auto", "hidden", "clip", "visible", "scroll"], Q = () => ["auto", p, r], l = () => [p, r], h = () => ["", F, _], g = () => ["auto", W, p], x = () => ["bottom", "center", "left", "left-bottom", "left-top", "right", "right-bottom", "right-top", "top"], b = () => ["solid", "dashed", "dotted", "double", "none"], w = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], S = () => ["start", "end", "center", "between", "around", "evenly", "stretch"], M = () => ["", "0", p], T = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], z = () => [W, p];
  return {
    cacheSize: 500,
    separator: ":",
    theme: {
    ...
    classGroups: {
       ...
       */
      leading: [{
        leading: ["none", "tight", "snug", "normal", "relaxed", "loose", F, p]
      }],
      /**
       * List Style Image
...
var dr = { twMerge: !0, twMergeConfig: {}, responsiveVariants: !1 }, Kt = (t) => t || void 0, tt = (...t) => Kt(Ft(t).filter(Boolean).join(" ")), lt = null, V = {}, pt = !1, J = (...t) => (r) => r.twMerge ? ((!lt || pt) && (pt = !1, lt = j(V) ? cr : lr({ ...V, extend: { theme: V.theme, classGroups: V.classGroups, conflictingClassGroupModifiers: V.conflictingClassGroupModifiers, conflictingClassGroups: V.conflictingClassGroups, ...V.extend } })), Kt(lt(tt(t)))) : tt(t), Et = (t, r) => {
  ...
  !j(c.twMergeConfig) && !Te(c.twMergeConfig, V) && (pt = !0, V = c.twMergeConfig);
  let v = j(e?.slots), P = j(o) ? {} : { base: tt(t?.base, v && e?.base), ...o }, A = v ? P : Et({ ...e?.slots }, j(P) ? { base: t?.base } : P), k = j(e?.compoundVariants) ? s : Vt(e?.compoundVariants, s), m = (y) => {
    ...
    let G = (l, h, g = [], x) => {
      ...
      return typeof I == "object" && typeof g == "string" && I[g] ? Et(I, at) : I.length > 0 ? (I.push(at), g === "base" ? I.join(" ") : I) : at;
    ...
    for (let l in y) y[l] !== void 0 && (K[l] = y[l]);
    let $ = (l, h) => {
      var g;
    ...
    if (!j(o) || !v) {
      let l = {};
      if (typeof A == "object" && !j(A)) for (let h of Object.keys(A)) l[h] = (g) => {
        var x, b;
        return J(A[h], et(h, g), ((x = H(g)) != null ? x : [])[h], ((b = Q(g)) != null ? b : [])[h], g?.class, g?.className)(c);
      };
      return l;
    }
    return J(d, O(), q(k), y?.class, y?.className)(c);
  }, C = () => {
    if (!(!u || typeof u != "object")) return Object.keys(u);
  };
  return m.variantKeys = C(), m.extend = e, m.base = d, m.slots = A, m.variants = u, m.defaultVariants = f, m.compoundSlots = i, m.compoundVariants = k, m;
};
const Er = (t) => t.match(/^\/assistant\/[^/]+(\/.*)?$/)?.[1] || "/";
function ur(t) {
    ...
    this.subscribe = (r) => (this.subscribers.push(r), () => {
      ...
      const n = a.then(async (d) => {
        if (i = [
          ...
          s = !1;
          const f = typeof e.error == "function" ? await e.error(`HTTP error! status: ${d.status}`) : e.error, v = typeof e.description == "function" ? await e.description(`HTTP error! status: ${d.status}`) : e.description, A = typeof f == "object" && !U.isValidElement(f) ? f : {
            message: f
          };
          this.create({
            id: o,
          ...
          s = !1;
          const f = typeof e.error == "function" ? await e.error(d) : e.error, v = typeof e.description == "function" ? await e.description(d) : e.description, A = typeof f == "object" && !U.isValidElement(f) ? f : {
            message: f
          };
          this.create({
            id: o,
          ...
          s = !1;
          const f = typeof e.success == "function" ? await e.success(d) : e.success, v = typeof e.description == "function" ? await e.description(d) : e.description, A = typeof f == "object" && !U.isValidElement(f) ? f : {
            message: f
          };
          this.create({
            id: o,
        ...
        if (i = [
          ...
          s = !1;
          const u = typeof e.error == "function" ? await e.error(d) : e.error, f = typeof e.description == "function" ? await e.description(d) : e.description, P = typeof u == "object" && !U.isValidElement(u) ? u : {
            message: u
          };
          this.create({
            id: o,
...
}, gr = (t) => t && typeof t == "object" && "ok" in t && typeof t.ok == "boolean" && "status" in t && typeof t.status == "number", hr = fr, br = () => N.toasts, mr = () => N.getActiveToasts(), Ar = Object.assign(hr, {
  success: N.success,
  info: N.info,
  warning: N.warning,
  error: N.error,
