import { p as Y } from "./chunk-4BX2VUAB-HhHWw7aj.js";
import { I as K } from "./chunk-QZHKN3VN-CH5_uzv8.js";
import { _ as l, J as U, I as V, s as X, h as J, i as Q, j as Z, m, k as rr, l as er, H as tr, X as ar, P as sr, y as C, Y as nr, Z as or, $ as cr, a0 as ir } from "./mermaid-VLURNSYL-KtsFwY3v.js";
import { p as dr } from "./treemap-KMMF4GRG-Cc2R6JQP.js";
var p = {
  NORMAL: 0,
  REVERSE: 1,
  HIGHLIGHT: 2,
...
var lr = /* @__PURE__ */ l(function(t) {
  ...
  c.records.branches.set(r, c.records.head != null ? c.records.head.id : null), c.records.branchConfig.set(r, { name: r, order: s }), F(r), m.debug("in createBranch");
...
var pr = /* @__PURE__ */ l(function() {
...
}, Ar = rr(), v = Ar?.gitGraph, L = 10, k = 40, E = 4, T = 2, M = 8, b = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), O = 30, R = /* @__PURE__ */ new Map(), A = [], B = 0, u = "LR", qr = /* @__PURE__ */ l(() => {
...
}, "findClosestParentBT"), Pr = /* @__PURE__ */ l((t, r, s) => {
  let n = s, e = s;
  const a = [];
  t.forEach((d) => {
    const o = r.get(d);
...
}, "setParallelBTPos"), _r = /* @__PURE__ */ l((t) => {
  ...
  return s;
}, "findClosestParentPos"), zr = /* @__PURE__ */ l((t) => _r(t) + k, "calculateCommitPosition"), Dr = /* @__PURE__ */ l((t, r) => {
  const s = b.get(t.branch);
  if (!s)
    throw new Error(`Branch not found for commit ${t.id}`);
  const n = s.pos, e = r + L;
  return w.set(t.id, { x: n, y: e }), { x: n, y: e };
}, "setCommitPosition"), Fr = /* @__PURE__ */ l((t, r, s) => {
  ...
  let h = d.sort(f);
  u === "BT" && (o && Pr(h, r, a), h = h.reverse()), h.forEach(($) => {
    const g = r.get($);
    if (!g)
...
`, "id:", r, s), !v)
  ...
  }), z(o, R, !1), v.showBranches && Jr(o, d), Xr(o, R), z(o, R, !0), tr.insertTitle(
    o,
    "gitTitleText",
    v.titleTopMargin ?? 0,
    a.getDiagramTitle()
